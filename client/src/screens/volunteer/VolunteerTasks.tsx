          ...
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-4 space-y-2">
              <p className="text-sm font-medium text-emerald-800">
                Delivery recorded. Share this feedback link with the recipient (e.g. via WhatsApp) if they didn’t get an email:
              </p>
        ...
        >
          ...
          >
            <CardContent className="p-4 space-y-4">
              <h3 className="font-semibold text-lg">Record delivery – end user details</h3>
              <p className="text-sm text-muted-foreground">
                Add recipient details. They will receive an email/SMS with a feedback link (provide at least email or phone).
              </p>
              {deliverError && (
              ...
              <div className="grid gap-3">
                ...
                <div>
                  <label className="text-xs text-muted-foreground">Email (for feedback link)</label>
                  <Input
                    type="email"
                ...
                <div>
                  <label className="text-xs text-muted-foreground">Phone (for feedback link)</label>
                  <Input
                    type="tel"
